...
How the GUI draws the game: the overall board layout, card rendering (face-up,
face-down, empty, with sprite and procedural-fallback paths), and the status and
feedback display (metrics, selection highlight, rejected-move messages).
