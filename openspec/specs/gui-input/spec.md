...
Mouse and keyboard interaction for the GUI: click-to-select a source,
click-to-move to a destination, dealing/recycling from the stock, auto-move
(double-click or key), and keyboard commands for the core session actions.
